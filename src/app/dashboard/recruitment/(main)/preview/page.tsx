    ...
    <div className="mt-5 bg-gray-50 px-5 py-5">
      <div className="mb-6 flex items-center rounded-lg bg-white p-2 shadow">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Lorem ipsum dolor sit amet consectetur. Facilisis egestas senean est
            volutpat tristique nisi morbi amet dictum. Massa morbi eget et donec
            non risus ipsum vitae. Vitae integer mattis.
          </p>
        </div>
      </div>
      ...
      <Section title="COVER LETTER" editable>
        <p className="text-gray-600">
          ...
          molestie libero. Praesent neque nulla sapien urna viverra bibendum ac
          nisi enim. Neque dolor urna integer ultricies moncus sit tristique.
          Vel risus fringilla venenatis mattis et purus. Amet cras quis dui mi.
          Gravida dictum lobortis vitae ac non. Eu turpis quam a amet
          sollicitudin elit velit at laoreet. Nibh egestas semper egestas
          commodo pulvinar. Ipsum elit nunc habitant fringilla morbi nec
          facilisis. Massa ipsum imperdiet enim gravida dignissim senean
          pellentesque sagittis. Neque fringilla fringilla venenatis quam sit
          orci quam. Donec diam elit nunc habitant fringilla lectus odio
          commodo. Faucibus volutpat eget nunc elit at. Nam velit adipiscing
          vitae quam elementum lorem non. Eu molestie lorem feugiat aliquam. Sed
          faucibus laoreet blandit lectus et suspendisse. At tristique.
        </p>
      </Section>
