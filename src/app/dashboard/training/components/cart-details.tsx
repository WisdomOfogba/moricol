...
const CartDetails = () => {
  ...
  return (
    <div>
      {cart.length === 0 ? (
        <div className="flex items-center justify-center h-40">Your Cart is Empty</div>
      ) : (
        <div>
          {cart.map((cart, i) => (
            <article key={i} className="grid grid-cols-[3fr_1fr_1fr] items-center gap-x-6 border-b border-b-[#E9EAF0] px-6 py-6 last:border-none">
            ...
            <div className="text-lg font-medium text-primary-500">₦{cart.price}</div>
